...
public class PpmoneyWebLoginServiceImpl implements PpmoneyWebLoginService {
	...
	public void doBefore() {
		...
		HttpGetUtils.sendGetStrReq(getLoginUrl(), true, true);
	}
	@Override
	...
	public static void main(String[] args) {
		PpmoneyWebLoginService login = new PpmoneyWebLoginServiceImpl();
		System.out.println(login.doLogin("13728670834", "feidee123", ""));
	}	
}
