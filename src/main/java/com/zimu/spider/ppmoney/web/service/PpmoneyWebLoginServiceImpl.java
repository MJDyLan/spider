...
public class PpmoneyWebLoginServiceImpl implements PpmoneyWebLoginService {
	...
	public static void main(String[] args) {
		String url = "https://www.ppmoney.com/login";
		...
		CookieManager.setCookie(cookieStr);
		String index = HttpGetUtils.sendGetStrReq(url, true, true,header);
		System.err.println(index);
		System.out.println(CookieManager.getCookie());
		Map<String,Object> requestMap = new HashMap<String, Object>();
		requestMap.put("Phone", "13728670834");
		requestMap.put("Password", "feidee123");
		requestMap.put("returnUrl", "");
		requestMap.put("RandCode", "");
		//TODO 调整后的域名没有加上
		String result = HttpPostUtils.sendPostReq(url, MapUtils.getParamStringEncoder(requestMap), true,true);
